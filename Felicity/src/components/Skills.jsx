...
// Importing icons for HTML, CSS, and JavaScript from react-icons
import { FaHtml5, FaCss3Alt, FaJs } from "react-icons/fa";

export default function Skills() {
  return (
    // Section wrapper with custom background, centered, and padding
    <section
      id="skills"
    ...
    >
      ...
      <div className="max-w-[1100px] w-full text-center">
        ...
        {/* Grid layout for skill categories, responsive across screen sizes */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          
           {/* Languages card with icons */}
            {/* Cards have got a white background,rounded corners, and when hovered they got an effect */}
          <div className="bg-white/85 rounded-2xl p-8 shadow-lg transition-all duration-300">
            ...
            <ul className="list-none p-0 flex justify-center items-center flex-col">
              {/* Each icon represents a language */}
